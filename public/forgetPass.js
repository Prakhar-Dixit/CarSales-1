 $(function (){
     ...
     function applypreloadercss()
     {
        ...
        preloader.css("background-image", "url('../assets/forgetPass_images/preloader.gif')");
      ...
      otpSubBtn.click(function(){
          ...
          else
          {
            ...
            function(data)
            {
                ...
                if(data.status == 'fail')
                {
                    window.alert("some error occured mail id provided by you might be wrong or you are not registered with please try again");
                }
                else
                {
